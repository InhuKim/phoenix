        ...
        >
          ...
          <Popover>
            <ListBox>
              ...
              <SelectItem key={TimePreset.last_hour} id={TimePreset.last_hour}>
                Last Hour
              </SelectItem>
              <SelectItem key={TimePreset.last_day} id={TimePreset.last_day}>
                Last Day
              </SelectItem>
              <SelectItem key={TimePreset.last_week} id={TimePreset.last_week}>
                Last Week
              </SelectItem>
              <SelectItem
              ...
              <SelectItem key={TimePreset.first_day} id={TimePreset.first_day}>
                First Day
              </SelectItem>
              <SelectItem
