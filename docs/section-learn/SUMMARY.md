...
* [LLM Ops Hub](https://arize.com/blog-course/introduction-fundamentals/)
...
* [Frequently Asked Questions](resources/faqs/README.md)
  ...
  * [How can I configure the backend to send the data to the phoenix UI in another container?](resources/faqs/how-can-i-configure-the-backend-to-send-the-data-to-the-phoenix-ui-in-another-container.md)
  * [Can I run Phoenix on Sagemaker?](resources/faqs/can-i-run-phoenix-on-sagemaker.md)
  * [Can I persist data in a notebook?](resources/faqs/can-i-persist-data-in-a-notebook.md)
  * [What is the difference between GRPC and HTTP?](resources/faqs/what-is-the-difference-between-grpc-and-http.md)
