...
Read more about comparison dataset Schemas here: [How many schemas do I need?](https://arize.com/docs/phoenix/\~/changes/v6Zhm276x8LlKmwqElIA/quickstart/inferences#how-many-schemas-do-i-need)
{% endhint %}
